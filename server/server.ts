...
import { doesItemNeedRevision, getItemMissingFields } from './src/utils.ts';
...
// Настройка CORS для запросов с frontend и preflight перед PUT
...
fastify.get<ItemGetRequest>('/items/:id', (request, reply) => {
  ...
  return {
    ...item,
    missingFields: getItemMissingFields(item),
